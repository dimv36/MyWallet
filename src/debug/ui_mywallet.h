...
public:
    ...
    void setupUi(QMainWindow *MyWallet)
    {
        ...
        _label_layout->setWidget(0, QFormLayout::LabelRole, _label_rest);
        ...
        _label_rest_value->setAlignment(Qt::AlignCenter);

        _label_layout->setWidget(0, QFormLayout::FieldRole, _label_rest_value);
        ...
        _menu_bar = new QMenuBar(MyWallet);
        _menu_bar->setObjectName(QStringLiteral("_menu_bar"));
        _menu_bar->setGeometry(QRect(0, 0, 704, 20));
        _menu_file = new QMenu(_menu_bar);
        _menu_file->setObjectName(QStringLiteral("_menu_file"));
        _menu_table = new QMenu(_menu_bar);
        _menu_table->setObjectName(QStringLiteral("_menu_table"));
        MyWallet->setMenuBar(_menu_bar);
        _main_tool_bar = new QToolBar(MyWallet);
        _main_tool_bar->setObjectName(QStringLiteral("_main_tool_bar"));
        MyWallet->addToolBar(Qt::TopToolBarArea, _main_tool_bar);
        _status_bar = new QStatusBar(MyWallet);
        _status_bar->setObjectName(QStringLiteral("_status_bar"));
        MyWallet->setStatusBar(_status_bar);

        _menu_bar->addAction(_menu_file->menuAction());
        _menu_bar->addAction(_menu_table->menuAction());
        ...
        _main_tool_bar->addAction(_action_add);
        _main_tool_bar->addAction(_action_remove);
        _main_tool_bar->addAction(_action_edit);
        _main_tool_bar->addAction(_action_settings);
    ...
    void retranslateUi(QMainWindow *MyWallet)
    {
        ...
        _action_edit->setToolTip(QApplication::translate("MyWallet", "\320\240\320\265\320\264\320\260\320\272\321\202\320\270\321\200\320\276\320\262\320\260\321\202\321\214 \321\217\321\207\320\265\320\271\320\272\321\203", 0));
#endif // QT_NO_TOOLTIP
        ...
        _label_rest_value->setText(QApplication::translate("MyWallet", "0", 0));
